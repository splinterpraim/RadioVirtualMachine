...
namespace rvm
{
    ...
    public:
         ...
         *
         * @param id[in] Identifier to Data Object
         * @param size[in] The size of the memory area(in bytes) for storing data to Data Object
         * @param accessTime[in]  Access time to data in ns.
